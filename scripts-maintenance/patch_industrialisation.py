...
# ============================================================
# PATCH 1 — Config : nb_articles_par_run mis a jour, PLANNING_SILOS retire
# ============================================================
ancien1 = '''    "nb_articles_par_run": 5,  # 1 par silo, 5 silos, 7j/7
...
if '"nb_articles_par_run": 9' in contenu:
    ...
    print("✅ PATCH 1 (config) : nb_articles_par_run=9, PLANNING_SILOS retire")

# ============================================================
# PATCH 2 — selectionner_silos_a_traiter : 3 silos, 3 articles chacun
# ============================================================
...
if "LOGIQUE INDUSTRIALISEE" in contenu:
    ...
    print("❌ PATCH 2 (selection industrialisee) : ancre non trouvee")
else:
    contenu = contenu.replace(ancien2, nouveau2, 1)
    print("✅ PATCH 2 (selection industrialisee) : 3 silos x 3 articles")
