...
nouvelle_route = '''@app.route('/rattraper-instagram', methods=['POST'])
...
if "rattraper_instagram" in contenu:
    print("⏭️  PATCH (endpoint rattraper-instagram) : deja present, ignore")
elif ancre not in contenu:
    print("❌ PATCH (endpoint rattraper-instagram) : ancre non trouvee")
else:
    contenu = contenu.replace(ancre, nouvelle_route + ancre, 1)
    print("✅ PATCH (endpoint rattraper-instagram) : ajoute")
